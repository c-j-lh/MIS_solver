...
setup_names = ('cinc', 'train100', 'train200', 'train300', 'chardened', 'hardened', 'dynUCB')  #, 'chardened', 'dynUCB') 
lay_names = ('Curriculum-Increasing', 'Train100', 'Train200', 'Train300', 'Curriculum-Hard-Graphs', 'Hard-Graphs', '$Q:V=12\\times 0.9^{e(e+1)/2}$') #, 'Hard-Graphs')
